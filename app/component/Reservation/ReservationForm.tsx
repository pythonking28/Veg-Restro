  ...
  return (
    <div className="bg-green-700 p-6 rounded-lg">
      ...
      <div className="mt-[2rem]">
        <div className="flex flex-cl sm:flex-row space-y-3 sm:space-y-0 items-center w-[80%] mx-auto justify-between space-x-4">
        ...
        rounded-lg outline-none font-bold text-[17px] text-white border-[2.2px] borer-gray-100" />
        <div className="mt-[2rem] w-[80%] text-center mx-auto">
          <button className="px-8 py-3 rounded-lg mb-[3rem] text-[16px] bg-blue-950 transition-all duration-200 hover:bg-red-600 text-white">Book Now</button>
